...
// in simulator we redefine to format for MiniApp Developer console
...
{\
	NSString * exceptionName = [@"org.miniapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miniapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMiniAppNativeItemNone = -1, 
	UIMiniAppNativeItemSpinner = -2,
	UIMiniAppNativeItemProgressBar = -3,
	
	UIMiniAppNativeItemSlider = -4,
	UIMiniAppNativeItemSwitch = -5,
	UIMiniAppNativeItemMultiButton = -6,
	UIMiniAppNativeItemSegmented = -7,
	
	UIMiniAppNativeItemTextView = -8,
	UIMiniAppNativeItemTextField = -9,
	UIMiniAppNativeItemSearchBar = -10,
	
	UIMiniAppNativeItemPicker = -11,
	UIMiniAppNativeItemDatePicker = -12,
	
	UIMiniAppNativeItemInfoLight = -13,
	UIMiniAppNativeItemInfoDark = -14,
	
	UIMiniAppNativeItemDisclosure = -15,
	
	UIMiniAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all MiniApp instances of
