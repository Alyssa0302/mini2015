...
//@interface MiniAppObject : NSObject
//@end

@interface MiniAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MiniAppObject class]])
		{
			for (NSString *key in [[(MiniAppObject*)o modules] allKeys])
			{
